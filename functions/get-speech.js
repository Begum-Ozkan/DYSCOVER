...
// get-speech.js dosyanızı DÜZENLEYİN
let credentials;
try {
  ...
  // GEÇİCİ DEĞİŞİKLİK: credentials = {}; yerine hatayı fırlat
  throw e; // Bu, Netlify dev terminalinde hatayı daha görünür hale getirecektir.
}
